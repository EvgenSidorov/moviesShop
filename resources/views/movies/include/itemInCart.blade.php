...
<div class="row mt-4 bg-light">
    ...
    <div class="col-2 offset-1 mt-2">
        <div class="d-flex mt-3 justify-content-around">
            <a href="{{ route('app.basket.remove', $movie['id']) }}" class="btn btn-danger minus">-</a>
            <h5>Count: </h5><h5 class="card-text text-center count">{{ $movie['count'] }}</h5>
            <a href="{{ route('app.basket.add', $movie['id']) }}" class="btn btn-success plus">+</a>
        </div>
    ...
    <div class="col-2 mt-2">
        ...
        <div class="d-flex mt-4 mx-2" style="">
            Total price: <p class="card-text mx-3 countTotal"
                           style="color:#f6931f; font-weight:bold;">{{number_format($movie['totalPrice'], 2)}} </p>$
        </div>
    </div>
    <div class="col-2 mt-2">
        <div class="d-flex mt-3 justify-content-around">
